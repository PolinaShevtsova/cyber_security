...
size = [32, 16]
kdf = KDF()
print(kdf.generate(pass1, salt1, context, size, 2))
print(kdf.generate(pass2, salt1, context, size, 2))
print(kdf.generate(pass1, salt2, context, size, 2))
RR = kdf.generate(pass1, salt2, ["МАСТЕР_КЛЮЧ"], [120], 2)
print(RR)
...
q = converter.msg2bin(test)
q1 = converter.msg2bin(test_1)
q2 = converter.msg2bin(test_2)
print(q, q1, q2)

print("============")
y = converter.bin2msg(q)
y1 = converter.bin2msg(q1)
y2 = converter.bin2msg(q2)
print(y, y1, y2)
X22 = converter.msg2bin(y2)
print(len(X22), len(q2))
print("========")
assocdata_array = [
...
print(l_L)
for i in range(l_L):
    print(len(converter.msg2bin(inputs_array[i])))

padder = MessagePadder()
in_ = inputs_array[0]
inter = padder.pad_message(in_)
print(len(converter.msg2bin(inter)))
out = padder.unpad_message(inter)
print(len(converter.msg2bin(out)))

in_ = inputs_array[1]
tmp = MessagePadder()._check_padding(converter.msg2bin(in_))
print(tmp)
inter = padder.pad_message(inputs_array[1])
print(len(converter.msg2bin(inter)))
tmp = MessagePadder()._check_padding(converter.msg2bin(inter))
print(tmp)
out = padder.unpad_message(inter)
print(len(converter.msg2bin(out)))
print(out == in_)
...
tmp = MessagePadder()._check_padding(converter.msg2bin(in2))
print(tmp)
...
out = padder.unpad_message(inter)
print(len(converter.msg2bin(out)))
print(converter.msg2bin(out) == converter.msg2bin(in_))
...
keyset = generator.produce_round_keys("СЕАНСОВЫЙ_КЛЮЧИК", 8, generator.make_lfsr_set())
print(tst)
print(keyset)
cfb = CFBCipher()
...
print(i_test1m[368:368+16], i_test1m)
...
print( i_test10 == tst, i_test10)
print(i_test1 == tst, i_test1)
...
transmission = eax.eax_cfb(ad, channel, "СЕАНСОВЫЙ_КЛЮЧИК", "СЕМИХАТОВ_КВАНТЫ", "recieve")
...
print(transmission[0][2] == messages[0], transmission[1][2] == messages[1], transmission[2][2] == messages[2],
      transmission[3][2] == messages[3], transmission[4][2] == messages[4], transmission[5][2] == messages[5])
print(converter.msg2bin(transmission[3][2]) == converter.msg2bin(messages[3]))
for i in transmission:
    print(i[3]) #