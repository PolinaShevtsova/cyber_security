...
out2 = feistal.frw_inner_Feistel(in2, key, 4)
print(out1, out2)
out3 = feistal.frw_inner_Feistel(in3, key, 1)
out4 = feistal.frw_inner_Feistel(in4, key, 1)
print(out3, out4)
lout1 = feistal.inv_inner_Feistel(out1, key, 2)
lout2 = feistal.inv_inner_Feistel(out2, key, 4)
print(lout1, lout2)
lout3 = feistal.inv_inner_Feistel(out3, key, 1)
lout4 = feistal.inv_inner_Feistel(out4, key, 1)
print(lout3, lout4)
